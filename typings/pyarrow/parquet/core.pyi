...
def write_table(table, where, row_group_size=..., version=..., use_dictionary=..., compression=..., write_statistics=..., use_deprecated_int96_timestamps=..., coerce_timestamps=..., allow_truncated_timestamps=..., data_page_size=..., flavor=..., filesystem=..., compression_level=..., use_byte_stream_split=..., column_encoding=..., data_page_version=..., use_compliant_nested_type=..., encryption_properties=..., write_batch_size=..., dictionary_pagesize_limit=..., store_schema=..., write_page_index=..., write_page_checksum=..., sorting_columns=..., store_decimal_as_integer=..., write_time_adjusted_to_utc=..., max_rows_per_page=..., **kwargs): # -> None:
    ...

_write_table_example = ...
def write_to_dataset(table, root_path, partition_cols=..., filesystem=..., schema=..., partitioning=..., basename_template=..., use_threads=..., file_visitor=..., existing_data_behavior=..., **kwargs): # -> None:
