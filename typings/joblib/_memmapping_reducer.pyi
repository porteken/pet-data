...
def reduce_array_memmap_backward(a): # -> tuple[Callable[..., memmap[_AnyShape, dtype[Any]] | NDArray[Any]], tuple[str | None, Any, str, int | Any, str, Any, Any | None, Any | None, bool]] | tuple[Callable[..., Any], tuple[bytes]]:
