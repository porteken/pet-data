...
3. `pull_cds.py` uses point-based ERA5 single-levels timeseries weather pulls for the shared summer window and tiled UTCI MRT pulls to write parquet partitions under `year=<year>/tile_id=<tile_id>/`.
