...
3. `pull_cds.py` uses point-based ERA5-Land timeseries weather pulls and tiled UTCI MRT pulls to write parquet partitions under `year=<year>/tile_id=<tile_id>/`.
